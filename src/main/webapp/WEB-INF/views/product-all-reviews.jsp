...
<body>
	...
	<div class="container">
		<header>
			...
			<nav>
				<a href="<c:url value='/product-detail/${product.idProduct}' />">Quay
					lại sản phẩm</a>
			</nav>
		</header>
					...
					<div class="product-details">
						...
						<c:if test="${product.discount > 0}">
							<del class="text-muted">
								<fmt:formatNumber value="${product.calSalePrice()}"
					...
					<div class="product-btns mt-4">
						<form action="addCart/${product.idProduct}" method="GET"
							...
							<c:choose>
								...
								<c:otherwise>
									<button type="button"
										class="add-to-cart-btn btn btn-danger btn-lg disabled"
										disabled>
		...
		<div class="back-button">
			...
			<a href="product-detail/${mahoaID}" class="btn btn-danger btn-lgy">Quay
				lại chi tiết sản phẩm</a>
		</div>
	</div>
