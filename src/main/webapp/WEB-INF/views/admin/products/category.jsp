								...
								<tbody>
									<c:forEach var="p" items="${products}">
										<tr>
											...
											<td>${p.quantity}</td>
											<td>
												<fmt:formatNumber value="${p.calOriginalPrice()}" type="number" groupingUsed="true" /> VNĐ
											</td>
											<td>
												<fmt:formatNumber value="${p.calSalePrice()}" type="number" groupingUsed="true" /> VNĐ
											</td>
											<td>
												<fmt:formatNumber value="${p.calPrice()}" type="number" groupingUsed="true" /> VNĐ
											</td>
											<td>${p.state}</td>
											<td><a
